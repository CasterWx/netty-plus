...
public abstract class AbstractChannel extends DefaultAttributeMap implements Channel {
    ...
    protected AbstractChannel(Channel parent) {
        System.out.println("[AbstractChannel]服务端/客户端公共的父类");
        this.parent = parent;
        id = newId(); // channel唯一标识
        System.out.println("[AbstractChannel] channel id唯一标识: [long]"+id.asLongText()+",[short]"+id.asShortText());
        unsafe = newUnsafe();
        System.out.println("[AbstractChannel] channel unsafe 底层操作初始化");
        pipeline = newChannelPipeline();
        System.out.println("[AbstractChannel] channel pipeline 初始化");
    }
